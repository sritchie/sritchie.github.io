...
#### Introduction to Summingbird (Sept 3rd, Bay Area Storm Users)<a id="sec-1-1" name="sec-1-1"></a>
...
#### Summingbird, Scala and Storm (Sept 25th, Boston Storm Users)<a id="sec-1-3" name="sec-1-3"></a>
...
#### Twitter: Taking Hadoop Realtime with Summingbird (Oct 19th, PNWScala)<a id="sec-1-4" name="sec-1-4"></a>
...
## Streaming MapReduce in Clojure (Nov 14-16, Clojure/Conj)<a id="sec-1-5" name="sec-1-5"></a>
...
#### So You Want to Build a MapReduce DSL? (Jan 11th, Data Day Texas, Austin TX)<a id="sec-1-6" name="sec-1-6"></a>
