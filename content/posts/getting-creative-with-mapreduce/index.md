...
date: 2011-09-29T22:24:00.000Z
slug: getting-creative-with-mapreduce
tags:
  - hadoop
  - code
  - cascalog
...
The [Cascalog](https://github.com/nathanmarz/cascalog) abstraction layer fixes this issue by separating logic from data, allowing you to play creatively at massive scale. (If you're not familiar with Cascalog, know that it's by far the most expressive MapReduce DSL in existence. We make heavy use of Cascalog here at Twitter. I recommend getting started with [this introduction](http://nathanmarz.com/blog/introducing-cascalog-a-clojure-based-query-language-for-hado.html), then moving on to [the wiki](http://www.assembla.com/wiki/show/d9Z8_q-Omr35zteJe5cbLr).)
...
*If you're interested in how to construct fact-based tests with midje-cascalog, I go into great detail on functional MapReduce testing idioms and methods in* [Testing Cascalog with Midje](http://sritchie.github.com/2011/09/30/testing-cascalog-with-midje.html).
