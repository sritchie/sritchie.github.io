---
title: "Book: The Second Kind of Impossible"
date: 2019-10-03T12:41:34.000Z
slug: book-the-second-kind-of-impossible
tags:
  - book-review
categories:
  - essays
...
I'm so glad I found "[The Second Kind of Impossible](https://amzn.to/2nfH6Li): the Extraordinary Quest for a New Form of Matter" by [Paul Steinhardt](https://en.wikipedia.org/wiki/Paul_Steinhardt). The book is a trip report of Paul's decades-long relationship with a peculiar type of matter called a "quasicrystal". I'll give a short summary, then discuss what struck me as so wonderful about the book, and finish out by including my more detailed notes in case you want to dig deeper.

### Summary

Paul is, I guess, best known for coming up with the [inflationary theory of the universe](https://en.wikipedia.org/wiki/Paul_Steinhardt#Inflationary_cosmology) in the early 80s; I would have imagined that that topic would be consuming. Shows what I know. Paul spent the summer of 1980 working on a computer simulation of what happens when you rapidly cool a liquid down to a frozen state.
...
{{< figure src="image.png" caption="From LibreTexts" >}}
...
I first encountered the idea of symmetry groups in Ian Stewart's [Concepts of Modern Mathematics](https://amzn.to/3114bQZ). Chapter 7 - "Symmetry: the Group concept" - covers the mathematics and builds up to an explanation of "[wallpaper groups](https://en.wikipedia.org/wiki/Wallpaper_group)", which is the 2-dimensional version of the mathematics behind crystallography (called "[space groups](https://en.wikipedia.org/wiki/Space_group)" in 3 dimensions).
...
{{< figure src="image-1.png" caption="Wallpaper Groups, from Wolfram's MathWorld" >}}
## Aperiodic Crystals
...
Before the actual discovery of DNA's double helix structure, the physicist Erwin Schrödinger, in 1944, had written a book called "[What is Life?](https://amzn.to/2nqZlgo)" ([Wikipedia page](https://en.wikipedia.org/wiki/What_Is_Life%3F)) that predicted that whatever it was in living things that carried hereditary information must be some sort of highly-ordered molecule with no periodic structure. From Wikipedia:

> Schrödinger explains that most physical laws on a large scale are due to chaos on a small scale. He calls this principle "order-from-disorder." As an example he mentions [diffusion](https://en.wikipedia.org/wiki/Diffusion), which can be modeled as a highly ordered process, but which is caused by random movement of atoms or molecules. If the number of atoms is reduced, the behaviour of a system becomes more and more random. He states that life greatly depends on order and that a naïve physicist may assume that the master code of a living organism has to consist of a large number of atoms.
...
[https://www.physics.princeton.edu/~steinh/](https://www.physics.princeton.edu/~steinh/)
...
Paul meets Dov Levine and they decide to work on a theoretical foundation for this new kind of matter; what could be causing five-fold symmetry? They find Penrose tilings. Here's a link again to the [Martin Gardner book ](https://amzn.to/2LgICqI)if you want to go deeper.

The first book encodes Paul's sense of a swelling crescendo of interest and excitement and effort.

We get an encounter with Feynman! Paul gets crushed by [Feynman lectures ](http://www.feynmanlectures.caltech.edu/)back in college. In junior year he gets the courage to ask Feynman to revive "Physics X", but for juniors and seniors.
...
Then on to the history of crystallography. [René Just Haüy](https://en.wikipedia.org/wiki/Ren%C3%A9_Just_Ha%C3%BCy#Crystallography ), the "father of modern crystallography", dropping a specimen of calcareous spar and discovering crystals shaped like a rhomboid...
...
Their inspiration was Penrose tilings: [https://en.wikipedia.org/wiki/Penrose_tiling](https://en.wikipedia.org/wiki/Penrose_tiling)
...
It's now 1999, and Ken Deffeyes, a Princeton geologist, enters the story. I last encountered Ken in John McPhee's "[Annals of the Former World](https://amzn.to/2oaU1OT)". Ken asks Paul if anyone's ever found a natural quasicrystal.
...
That's all I've got for now. Go get yourself a copy of "[The Second Kind of Impossible](https://amzn.to/2o9MEaC)" and revel in the detective tale that Paul's put together.
